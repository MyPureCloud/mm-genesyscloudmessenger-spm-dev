...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloudMessenger",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger-0.0.5.zip",
            checksum: "2a98514c146e8e55150c11c47d2242e516a2fe98e2a7c911b502e5c5cfd1953d"
        ),
        .target(
