...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloudMessenger",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger_version_t1.16.0.rc1_commit_fc8e76f35dde667be1a0ddc3814dc64ce5141e73.zip",
            checksum: "504c0b8e2bbf0bc62f1ba99366826e447b1ca5fea4b800467f9271c7032fd548"
        ),
        .target(
