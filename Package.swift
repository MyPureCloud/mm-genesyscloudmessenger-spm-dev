...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "GenesysCloudMessenger",
            url: "https://genesysdx.jfrog.io/artifactory/genesys-cloud-ios.dev/GenesysCloudMessenger/GenesysCloudMessenger_version_t1.15.0.rc39_commit_6141224dc529b670722f075b9afb522ee12e2127.zip",
            checksum: "ede2e0f0d2effff3234a4500d9709823543d643b773ed6769359d63c51938a62"
        ),
        .target(
